...
segparam = [2  10 0.1   0 -999 0 -999 0 0.01;    % 1 - Level acceleration for 10 seconds
            4 NaN NaN NaN -999 0   10 1 0.01;    % 2 - pitch up transition
            1  15 NaN NaN -999 0 -999 0 0.01;    % 3 - 15 second climb
            4 NaN NaN NaN -999 0    0 1 0.01;    % 4 - level off
            4 NaN NaN NaN  -15 3 -999 0 0.01;    % 5 - roll into a turn
            3 NaN NaN  90 -999 0 -999 0 0.01;    % 6 - 90 degree turn
            4 NaN NaN NaN    0 3 -999 0 0.01;    % 7 - roll back to straight and level
            1  10 NaN NaN -999 0 -999 0 0.01;    % 8 - 10 second straight segment to the West?
            4 NaN NaN NaN  -15 3 -999 0 0.01;    % 5 - roll into a turn
            3 NaN NaN  90 -999 0 -999 0 0.01;    % 6 - 90 degree turn
            4 NaN NaN NaN    0 3 -999 0 0.01;    % 7 - roll back to straight and level
            1  10 NaN NaN -999 0 -999 0 0.01;    % 8 - 10 second straight segment to the West?            
